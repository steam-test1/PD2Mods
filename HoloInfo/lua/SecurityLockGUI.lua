...
HoloInfo:clone(SecurityLockGui)
function SecurityLockGui:init(...)
	self.old.init(self, ...)
	self._unit_names_id = {"", "", "", ""}
	self._unit_names = {
	    drill = "Drill", 
...
function SecurityLockGui:_set_jammed(...)
...
function SecurityLockGui:_set_powered(...)
...
function SecurityLockGui:post_event(...)
...
DrillTimerGui = DrillTimerGui or class(SecurityLockGui)
